...
public:
  ...
  //Added by 1705087
  bool GetBlackHoleNode () const
  {
    return m_IsBlackHoleNode;
  }
...
private:
  ...
  bool m_IsBlackHoleNode;              ///Added by 1705087
  //\}
  ...
  /// Added by 1705087 - Routing Table New Feild - Sh value
  //uint32_t dynamic_seqNo;
  uint32_t node_stat;
