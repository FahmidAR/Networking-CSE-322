...
RoutingProtocol::RoutingProtocol ()
  : m_rreqRetries (2),
    ...
    m_rreqCount (0),
    m_rerrCount (0),
    /// Added by 1705087 - Routing Table - Sh value initalize
    //dynamic_seqNo (0),
    node_stat (0),
...
RoutingProtocol::SetIpv4 (Ptr<Ipv4> ipv4)
{
  ...
  RoutingTableEntry rt (/*device=*/ m_lo, /*dst=*/ Ipv4Address::GetLoopback (), /*know seqno=*/ true, /*seqno=*/ 0,
                                    ...
                                    /*lifetime=*/ Simulator::GetMaximumSimulationTime (),0);
...
RoutingProtocol::NotifyInterfaceUp (uint32_t i)
{
  ...
  RoutingTableEntry rt (/*device=*/ dev, /*dst=*/ iface.GetBroadcast (), /*know seqno=*/ true, /*seqno=*/ 0, /*iface=*/ iface,
                                    /*hops=*/ 1, /*next hop=*/ iface.GetBroadcast (), /*lifetime=*/ Simulator::GetMaximumSimulationTime (),0);
  m_routingTable.AddRoute (rt);
      ...
      if (!socket)
        {
          ...
          RoutingTableEntry rt (/*device=*/ dev, /*dst=*/ iface.GetBroadcast (), /*know seqno=*/ true,
                                            ...
                                            /*next hop=*/ iface.GetBroadcast (), /*lifetime=*/ Simulator::GetMaximumSimulationTime (),0);
          m_routingTable.AddRoute (rt);
        }
    }
  else
...
RoutingProtocol::SendRequest (Ipv4Address dst)
{
  ...
  if (m_routingTable.LookupRoute (dst, rt))
  ...
  else
    {
      ...
      RoutingTableEntry newEntry (/*device=*/ dev, /*dst=*/ dst, /*validSeqNo=*/ false, /*seqno=*/ 0,
                                              ...
                                              /*nextHop=*/ Ipv4Address (), /*lifeTime=*/ m_pathDiscoveryTime,0);
  ...
  //Thingked by 1705087- One increament only
  m_seqNo++;
  ...
  if (!m_routingTable.LookupRoute (sender, toNeighbor))
    {
      ...
      RoutingTableEntry newEntry (/*device=*/ dev, /*dst=*/ sender, /*know seqno=*/ false, /*seqno=*/ 0,
                                              ...
                                              /*hops=*/ 1, /*next hop=*/ sender, /*lifetime=*/ m_activeRouteTimeout,0);
      m_routingTable.AddRoute (newEntry);
    }
  else
    {
      ...
      if (toNeighbor.GetValidSeqNo () && (toNeighbor.GetHop () == 1) && (toNeighbor.GetOutputDevice () == dev))
      ...
      else
        {
          RoutingTableEntry newEntry (/*device=*/ dev, /*dst=*/ sender, /*know seqno=*/ false, /*seqno=*/ 0,
                                                  /*iface=*/ m_ipv4->GetAddress (m_ipv4->GetInterfaceForAddress (receiver), 0),
                                                  /*hops=*/ 1, /*next hop=*/ sender, /*lifetime=*/ std::max (m_activeRouteTimeout, toNeighbor.GetLifeTime ()),0);
...
RoutingProtocol::RecvRequest (Ptr<Packet> p, Ipv4Address receiver, Ipv4Address src)
{
  ...
  if (!m_routingTable.LookupRoute (origin, toOrigin))
    {
      ...
      RoutingTableEntry newEntry (/*device=*/ dev, /*dst=*/ origin, /*validSeno=*/ true, /*seqNo=*/ rreqHeader.GetOriginSeqno (),
                                              ...
                                              /*nextHop*/ src, /*timeLife=*/ Time ((2 * m_netTraversalTime - 2 * hop * m_nodeTraversalTime)),0);
      m_routingTable.AddRoute (newEntry);
    }
  else
    {
  ...
  if (m_routingTable.LookupRoute (dst, toDst)||m_IsBlackHoleNode)
    {
      /*
       * Drop RREQ, This node RREP will make a loop.
       */
      if (toDst.GetNextHop () == src||m_IsBlackHoleNode)
        {
      ...
      if (((rreqHeader.GetUnknownSeqno () || (int32_t (toDst.GetSeqNo ()) - int32_t (rreqHeader.GetDstSeqno ()) >= 0))
          && toDst.GetValidSeqNo () )||m_IsBlackHoleNode)
        {
...
RoutingProtocol::RecvReply (Ptr<Packet> p, Ipv4Address receiver, Ipv4Address sender)
{
  ...
  RoutingTableEntry newEntry (/*device=*/ dev, /*dst=*/ dst, /*validSeqNo=*/ true, /*seqno=*/ rrepHeader.GetDstSeqno (),
                                            ...
                                            /*nextHop=*/ sender, /*lifeTime=*/ rrepHeader.GetLifeTime (),0); 
  ...
  if(rrepHeader.GetDstSeqno()>sh)
  {
    RoutingTableEntry newEntry (
      ...
      /*iface=*/ m_ipv4->GetAddress (m_ipv4->GetInterfaceForAddress (receiver), 0),/*hop=*/ 120, // Increase Hop Count
  ...
  if (!m_routingTable.LookupRoute (rrepHeader.GetDst (), toNeighbor))
    {
      ...
      RoutingTableEntry newEntry (/*device=*/ dev, /*dst=*/ rrepHeader.GetDst (), /*validSeqNo=*/ true, /*seqno=*/ rrepHeader.GetDstSeqno (),
                                              /*iface=*/ m_ipv4->GetAddress (m_ipv4->GetInterfaceForAddress (receiver), 0),
                                              /*hop=*/ 1, /*nextHop=*/ rrepHeader.GetDst (), /*lifeTime=*/ rrepHeader.GetLifeTime (),0);
      m_routingTable.AddRoute (newEntry);
    }
  else
    {
