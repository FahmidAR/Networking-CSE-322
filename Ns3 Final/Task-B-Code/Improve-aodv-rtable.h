...
public:
   ...
   */
     RoutingTableEntry (Ptr<NetDevice> dev = 0,Ipv4Address dst = Ipv4Address (), bool vSeqNo = false, uint32_t seqNo = 0,
                     ...
                     Ipv4Address nextHop = Ipv4Address (), Time lifetime = Simulator::Now (),uint32_t malNode =0);
   ...
   */
   //added 1705087
   //bool InsertSat (uint32_t malNode);
